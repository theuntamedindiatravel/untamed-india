...
export const testimonials = [
  {
    id: 1,
    name: 'Sophie & Mark Hargreaves',
    role: 'Travelled from the UK',
    initials: 'SH',
    tour: 'The Grand Tiger Expedition',
    rating: 5,
    text: 'The Untamed India did not just show us tigers — they invited us into a world most people never get to see. Our naturalist Rajan tracked a female and her two cubs with such patience and respect. We sat in silence for nearly 40 minutes just watching them. No other operator we\'ve used has come close to this level of expertise.',
  },
  {
    id: 2,
    name: 'Priyanka Nair',
    role: 'Solo traveller, Bangalore',
    initials: 'PN',
    tour: 'Ranthambore Tiger Reserve — Private Safari',
    rating: 5,
    text: 'I was nervous about travelling solo but The Untamed India made me feel completely safe and included. The guide knew every corner of the reserve and explained animal behaviour in a way that genuinely changed how I see wildlife. I\'ve already booked again for Kaziranga next winter.',
  },
  {
    id: 3,
    name: 'Thomas van der Berg',
    role: 'Wildlife photographer, Netherlands',
    initials: 'TV',
    tour: 'Bharatpur & Corbett Photography Retreat',
    rating: 5,
    text: 'As a photographer I\'ve done wildlife trips across Africa and South America. The Untamed India set a new standard. Early-morning access before the park officially opened, a low-profile jeep with a proper beanbag mount, and a guide who anticipated animal movement better than anyone I\'ve worked with. My shots from Corbett are now hanging in a gallery in Amsterdam.',
  },
  {
    id: 4,
    name: 'The Krishnamurthy Family',
    role: 'Family of four, Chennai',
    initials: 'KF',
    tour: 'Kabini & Nagarhole Family Safari',
    rating: 5,
    text: 'Our kids (9 and 12) were completely hooked from day one. The team made the experience educational without it feeling like school. We spotted wild dogs, a leopard at dusk, and a breeding herd of elephants — all in three days. The accommodation they arranged was spectacular. We came home as a changed family.',
  },
  {
    id: 5,
    name: 'Claire Fontaine',
    role: 'Conservation researcher, France',
    initials: 'CF',
    tour: 'The Lion of Sasan: Gir Safari',
    rating: 5,
    text: 'I study large carnivores professionally, so I came with high expectations and plenty of scepticism. The Untamed India exceeded both. Their relationship with the Gir forest department is clearly built on years of genuine trust — we spent an afternoon with a ranger who has monitored the same lion pride for eleven years. That kind of access is irreplaceable.',
  },
];
